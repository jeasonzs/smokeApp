...
public class SettingAboutUsActivity extends Activity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ImageButton)findViewById(R.id.imageButtonSettingAboutUsReturn)).setOnTouchListener(this);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {   
    	...
    	if(event.getAction()==MotionEvent.ACTION_DOWN){ 
	        ...
	        switch (v.getId()) {  
	        	case R.id.imageButtonSettingAboutUsReturn:
	        		finish();
	        		break;
	        } 
    	}
